...
const updateUser = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userData.role &&
        ...
        userData.role !== 'buyer') {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Role must be either seller or buyer');
    }
...
const updateMyProfile = (payload, updatedData) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield users_model_1.User.findById(payload.id);
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'User not found');
    }
