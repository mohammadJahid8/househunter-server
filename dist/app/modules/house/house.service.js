...
const createHouse = (authUser) => __awaiter(void 0, void 0, void 0, function* () {
...
const getHouseByToken = (user) => __awaiter(void 0, void 0, void 0, function* () {
    const email = user.email;
    const result = yield house_model_1.House.find({
        owner: email,
    });
    return result;
});
const updateHouse = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
