...
const createHouse = (0, catchAsync_1.default)((req, res) =>
...
const getAllHouses = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_1.paginationFields
    );
    const result = yield house_service_1.HouseService.getAllHouses(
      req.query,
      paginationOptions
    );
    (0, sendResponse_1.default)(res, {
...
const getSingleHouse = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateHouse = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    ...
    const result = yield house_service_1.HouseService.updateHouse(
      id,
      updatedData
    );
    (0, sendResponse_1.default)(res, {
...
const deleteHouse = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
